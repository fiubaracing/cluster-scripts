...
if "%REGION%" == "" (
set COMMAND=decomposePar -noFunctionObjects %TIME_STEPS% -case "%CASE%" %CONSTANT% %ALL_REGIONS%
) else (
set COMMAND=decomposePar -noFunctionObjects %TIME_STEPS% -case "%CASE%" %CONSTANT% %REGION%
)
