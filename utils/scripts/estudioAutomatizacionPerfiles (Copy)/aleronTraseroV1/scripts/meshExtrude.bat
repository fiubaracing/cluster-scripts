...
if %NP% LSS 2 (
set COMMAND=extrudeMesh %REGION% -noFunctionObjects -overwrite -case "%CASE%"
) else (
set COMMAND=%MPICOMMAND% extrudeMesh -parallel %REGION% -noFunctionObjects -overwrite -case "%CASE%"
)
