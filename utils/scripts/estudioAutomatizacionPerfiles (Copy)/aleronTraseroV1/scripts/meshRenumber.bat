...
if %NP% LSS 2 (
set COMMAND=renumberMesh %ALL_REGIONS% %CONSTANT% -overwrite -noFunctionObjects -case "%CASE%"
) else (
set COMMAND=%MPICOMMAND% renumberMesh %ALL_REGIONS% %CONSTANT% -parallel -overwrite -noFunctionObjects -case "%CASE%"
)
